...
if(service_location == "") {
  ...
  if (download == "y") {
    ...
    if (dir.exists(dest)) {
      ...
      download.file(sprintf(test_files_url_template, "core", "montly"), paste0(dest, "core/monthlyrep.parquet"))
      download.file(sprintf(test_files_url_template, "core", "trimester"), paste0(dest, "core/trimesterrep.parquet"))
      download.file(sprintf(test_files_url_template, "outcome", "nonrep"), paste0(dest, "outcome/nonrep.parquet"))
...
wait_for_input()
cat("\nVerify core contains nonrep, yearlyrep, montlyrep and trimesterrep")
wait_for_input()
