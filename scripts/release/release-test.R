...
ds.glmSLMA(formula = 'preg_dia ~ agebirth_m_y + ethn3_m + sex', family = 'gaussian',
           dataName = 'core_nonrep', newobj = 'out.fit.1a')

med_out <- ds.mediate(model.m = 'med.fit.1a', model.y = 'out.fit.1a', treat = "ethn3_m",
                         mediator = "agebirth_m_y", boot = FALSE, conf.level = 0.95,
                         robustSE = TRUE, sims = 100, seed = 123, newobj = 'med.out.1a')
