...
##### Step 1
Download setup script [https://raw.githubusercontent.com/molgenis/molgenis-service-armadillo/master/scripts/install/armadillo-setup.sh](here "download") or via commandline:
```bash
