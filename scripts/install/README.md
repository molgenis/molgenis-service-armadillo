...
##### Step 1
Download setup script [here](https://raw.githubusercontent.com/molgenis/molgenis-service-armadillo/master/scripts/install/armadillo-setup.sh "download") or via commandline:
```bash
