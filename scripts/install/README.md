...
##### Step 1
Download setup script <a href="https://github.com//molgenis/molgenis-service-armadillo/blob/master/scripts/install/armadillo-setup.sh" download="armadillo-setup.sh">here</a> or via commandline:
```bash
