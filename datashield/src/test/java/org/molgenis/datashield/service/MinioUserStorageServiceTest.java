...
class MinioUserStorageServiceTest {

  private MinioUserStorageService minioUserStorageService;
  @Mock private MinioClient minioClient;
  @Mock private MinioUserStorageConfig minioConfig;
  ...
  public void beforeEach() {
    ...
    minioUserStorageService = new MinioUserStorageService(minioClient, minioConfig);
  }
  ...
  public void testCheckBucketExistsThrowsExceptionIfMinioDown() throws Exception {
    ...
    assertThrows(StorageException.class, minioUserStorageService::checkBucketExists);
  }
  ...
  public void testCheckBucketExistsCreatesBucketIfNotFound() throws Exception {
    ...
    minioUserStorageService.checkBucketExists();
  ...
  public void save() throws Exception {
    minioUserStorageService.save(inputStream, "asdf.blah", APPLICATION_OCTET_STREAM);
  ...
  public void testListWorkspaces() throws Exception {
    ...
    assertEquals(List.of(workspace), minioUserStorageService.listWorkspaces("admin/"));
  }
  ...
  public void testLoad() throws Exception {
    ...
    assertSame(inputStream, minioUserStorageService.load("admin/blah.RData"));
  }

  @Test
  public void testDelete() throws Exception {
    minioUserStorageService.delete("admin/blah.RData");
