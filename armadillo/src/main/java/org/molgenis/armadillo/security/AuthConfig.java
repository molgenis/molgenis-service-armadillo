...
public class AuthConfig {
  ...
  //                    //allow docs to be accessed publically
  //                    .antMatchers(
  //                            "/v3/**",
  //                            "/swagger-ui/**",
  //                            "/ui/**",
  ...
  //                            oauth2 ->
  //                                    oauth2.jwt(jwt ->
  // jwt.jwtAuthenticationConverter(grantedAuthoritiesExtractor()))).exceptionHandling()
  //                    //otherwise offer login
  //                    .and()
  ...
  //                    List<String> authorizedProjects =
  // accessStorageService.getGrantsForEmail((String) userAttributes.get("email"));
  //                    mappedAuthorities.addAll(authorizedProjects
  //                            .stream()
  //                            .map(project -> "administrators".equals(project) ? "ROLE_SU" :
  // "ROLE_" + project + "_RESEARCHER")
