  ...
  public FileDetails fileDetails(String file_id) {
    return switch (file_id) {
      case "LOGGER_INFO" -> FileDetails.create(
          file_id, "Logger info", (new FileService()).DumpLoggers(), getServerTime());
      case "LOG_FILE" -> FileDetails.create(
          file_id, "Log file", (new FileService()).readLogFile(logFilePath), getServerTime());
      case "AUDIT_FILE" -> FileDetails.create(
          file_id, "Audit file", (new FileService()).readLogFile(auditFilePath), getServerTime());
