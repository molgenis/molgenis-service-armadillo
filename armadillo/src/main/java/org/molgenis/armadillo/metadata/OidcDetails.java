...
public abstract class OidcDetails implements Persistable {
  ...
  @JsonProperty("deviceIssuerUri")
  @Nullable
  // in application.yml
  public abstract String getDeviceIssuerUri();
  ...
  public static OidcDetails create(
      ...
      @JsonProperty("deviceIssuerUri") String deviceIssuerUri,
      @JsonProperty("deviceClientId") String deviceClientId) {
    return new AutoValue_OidcDetails(
        issuerUri, clientId, clientSecret, deviceIssuerUri, deviceClientId);
  }
}
