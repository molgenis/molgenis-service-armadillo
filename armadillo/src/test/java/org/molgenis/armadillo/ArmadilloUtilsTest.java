...
class ArmadilloUtilsTest {
  ...
  void testHexDumpHelloWorld() {
    ...
    assertEquals("48 65 6c 6c 6f 20 57 6f  |Hello Wo|\n72 6c 64 21              |rld!....|", dump);
  }

  @Test
  void testHexDumpAllBytes() {
    ...
    assertEquals(
        "00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f  |................|\n"
            ...
            + "a0 a1 a2 a3 a4 a5 a6 a7 a8 a9 aa ab ac ad ae af  | ¡¢£¤¥¦§¨©ª«¬\u00AD®¯|\n"
            + "b0 b1 b2 b3 b4 b5 b6 b7 b8 b9 ba bb bc bd be bf  |°±²³´µ¶·¸¹º»¼½¾¿|\n"
            + "c0 c1 c2 c3 c4 c5 c6 c7 c8 c9 ca cb cc cd ce cf  |ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏ|\n"
            + "d0 d1 d2 d3 d4 d5 d6 d7 d8 d9 da db dc dd de df  |ÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞß|\n"
            + "e0 e1 e2 e3 e4 e5 e6 e7 e8 e9 ea eb ec ed ee ef  |àáâãäåæçèéêëìíîï|\n"
            + "f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 fa fb fc fd fe ff  |ðñòóôõö÷øùúûüýþÿ|",
        ArmadilloUtils.hexDump(bytes));
  }
}
